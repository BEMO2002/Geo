  ...
  return (
    <div className="flex flex-col md:flex-row  min-h-0.5 pb-20">
      ...
      <div className="flex-1 overflow-hidden">
        <img src={splitImg} alt="Recent Work" className="w-full h-full object-cover" />
      </div>
      {/* Right Side - Content */}
      <div className="flex-1 bg-[#0a4267d4] text-white flex flex-col justify-center items-start px-[8vw] relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl">
          ...
          <button
            className="px-9 py-4 text-lg mb-6 font-semibold border-2 border-white rounded transition bg-transparent text-white hover:bg-white duration-300 hover:text-[#0a4267] focus:outline-none"
          >
            OUR PROJECTS
          </button>
        </div>
