...
const Navbar = () => {
  ...
  const NavLink = ({ to, children, onClick }) => (
    <Link
      to={to}
      className={`relative group px-[16px] py-[8px] text-[16px] font-[600] leading-[26px] ${
        isActive(to)
          ? "text-primary"
    ...
    >
      <div className="max-w-[1650px] mx-auto md:px-[120px] px-4 py-1 gap-[32px] sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link to="/">
          <img src={logo} alt="" className="md:w-70 w-40"/>
          </Link>
          ...
          <div className="hidden lg:flex">
            <Link
              to="/contact"
              className="relative w-full md:w-[347px] h-[48px] inline-flex items-center justify-center gap-2 px-[16px] py-[8px] font-[700] border  text-[16px] leading-[26px] rounded-[8px] text-white hover:text-primary hover:border-1 bg-primary hover:bg-[#fff] focus:outline-none transition-colors duration-300"
            >
              <GoRocket size={24}/>
            ...
            >
              ...
              <div className="flex flex-col items-center w-full py-4">
                ...
                <div className="w-full flex flex-col items-center space-y-4">
                  ...
                  <NavLink to="/who" onClick={toggleMenu}>Who We Are
                  </NavLink>
                  <NavLink to="/services" onClick={toggleMenu}>What We Do</NavLink>
                ...
                <div className="w-full px-4 pt-6">
                  <Link
                    to="/contact"
                    className="w-full md:w-[300px] h-[48px] flex justify-center gap-2 px-[16px] py-[8px] font-[700] border  text-[16px] leading-[26px] rounded-[8px] text-white hover:text-primary hover:border-1 bg-primary hover:bg-[#fff] transition-colors duration-300"
                  >
                    <GoRocket size={24} />
                    Lets Grow Your business
                  </Link>
