    ...
    <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center lg:gap-20 gap-10 py-8 px-4 md:px-12">
      ...
      <div className="flex-1  text-base md:text-lg font-normal">
        ...
        <p className="mb-5 leading-relaxed ">
          From geosynthetic reinforcements to facing panels, we supply all
          necessary materials and provide complete installation services. Our
          crews are trained and certified to deliver safe, timely, and precise
          wall construction, including precast concrete facing panels, soil
          reinforcements, and attachment devices.
        </p>
      </div>
    </div>
  );
